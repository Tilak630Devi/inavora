      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-4xl">
          <div className="flex items-center justify-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">{t('slide_editors.instruction.presenter_title')}</h2>
          </div>
          ...
          <div className="bg-[#1F1F1F] rounded-xl overflow-hidden border border-[#3B3B3B] shadow-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-center justify-center p-6 bg-[#2A2A2A] rounded-lg">
                <h3 className="text-xl font-semibold text-white mb-4">{t('slide_editors.instruction.presenter_join_via_website_title')}</h3>
              ...
              <div className="flex flex-col items-center justify-center p-6 bg-[#2A2A2A] rounded-lg">
                <h3 className="text-xl font-semibold text-white mb-4">{t('slide_editors.instruction.presenter_scan_qr_code_title')}</h3>
                <p className="text-gray-300 mb-4 text-center">
